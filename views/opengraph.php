...
<html>
	<head>
		<meta property="og:image" content="<?php echo app()->config->baseUrl . '/thumb/' . $item->slug ?>.jpg?s=1200&h=<?php echo hash_hmac('sha256', $item->slug . '1200', app()->config->loginSecret); ?>" />
